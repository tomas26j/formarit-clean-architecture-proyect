...
export interface RepositorioReservas {
     ...
     */
    buscarPorRangoFechas(fechaInicio: Date, fechaFin: Date): Promise<Result<Reserva[], DomainError>>;
    /**
     ...
     */
    listar(limit?: number, offset?: number): Promise<Result<Reserva[], DomainError>>;
}
