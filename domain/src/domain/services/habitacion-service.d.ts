...
export interface HabitacionService {
     ...
     */
    validarCreacionHabitacion(numero: string, tipoId: string, precioBase: Precio, piso: number): Result<boolean, DomainError>;
    /**
     ...
     */
    crearHabitacion(id: string, numero: string, tipo: any, // TipoHabitacion
    precioBase: Precio, piso: number, vista: string): Result<Habitacion, DomainError>;
    /**
